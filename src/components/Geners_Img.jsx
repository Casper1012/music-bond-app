...
const Geners_Img = ({ url, text }) => {
    return (
        <div className="group top-[24px] left-[17px] relative">
            ...
            <p className='cursor-default group-hover:translate-x-[0.2px] group-hover:translate-y-[-0.2px] min-h-[60px] text-white group-hover:text-[rgba(0,96,217,1)] text-center font-bold text-sm leading-[17.64px] mt-[6px] whitespace-normal w-[137px] transition-all duration-300 ease-in-out'>{ text }</p>
        </div>
    );
}
